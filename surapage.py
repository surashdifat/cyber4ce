...
def render_service():
    st.set_page_config(
        page_title="Phishing Link Scanner",
        page_icon="🛡️",
        layout="wide"
    )
...
body{background:var(--bg-main);color:var(--text-main);font-family:var(--font-mono);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:40px 20px;overflow-x:hidden;position:relative}
...
.container{width:100%;max-width:680px;display:flex;flex-direction:column;gap:30px;animation:fadeIn .8s ease;position:relative;z-index:1}
.hero-section{display:flex;flex-direction:column;align-items:center;gap:20px;position:relative;padding:30px 0}
.hero-rings{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:280px;height:280px;pointer-events:none}
...
.ring-1{width:140px;height:140px;opacity:.5;animation:ringPulse 3s ease-in-out infinite}
.ring-2{width:200px;height:200px;opacity:.25;animation:ringPulse 3s ease-in-out infinite .5s;border-style:dashed}
.ring-3{width:280px;height:280px;opacity:.15;animation:ringPulse 3s ease-in-out infinite 1s}
@keyframes ringPulse{0%,100%{transform:translate(-50%,-50%) scale(1);opacity:.5}50%{transform:translate(-50%,-50%) scale(1.05);opacity:.2}}
.hero-shield{width:90px;height:90px;color:var(--cyan-main);filter:drop-shadow(0 0 15px rgba(6,182,212,.6)) drop-shadow(0 0 30px rgba(6,182,212,.15));animation:shieldFloat 4s ease-in-out infinite;position:relative;z-index:2}
.hero-shield svg{width:100%;height:100%}
@keyframes shieldFloat{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)}}
.hero-orbit{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:240px;height:240px;pointer-events:none}
.orbit-item{position:absolute;width:32px;height:32px;color:var(--cyan-light);background:var(--bg-panel);border:1px solid var(--border-bright);border-radius:50%;padding:7px;box-shadow:0 0 15px rgba(6,182,212,.15),inset 0 0 10px rgba(6,182,212,.15);animation:orbitFloat 5s ease-in-out infinite}
...
.hero-title{font-family:var(--font-display);font-size:1.8rem;font-weight:700;letter-spacing:4px;color:var(--text-main);text-align:center;margin-top:30px;text-shadow:0 0 20px rgba(6,182,212,.6),0 0 40px rgba(6,182,212,.15);position:relative;z-index:2}
.hero-subtitle{font-family:var(--font-mono);font-size:.85rem;letter-spacing:4px;color:var(--cyan-light);text-transform:uppercase;opacity:.8;position:relative;z-index:2}
...
<section class="history-panel" id="historyPanel" style="display:none"><div class="panel-header"><span class="panel-dot"></span><span class="panel-title">RECENT SCANS</span></div><ul class="history-list" id="historyList"></ul></section>
...
li.appendChild(u);li.appendChild(s);
...
setTimeout(function(){urlInput.style.borderColor=""},1000);
return
}
resultSection.style.display="none";
